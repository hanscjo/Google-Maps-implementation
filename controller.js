...
function geocode(request, id) {
  geocoder.geocode(request)
    .then((result) => {
      ...
      tempLat = (viewport.fb.hi + viewport.fb.lo) / 2; //Denne breaka en gang fordi google valgte å bytte fra fb til eb. Men det viser seg at man skal bruke getLng() og getLat()
